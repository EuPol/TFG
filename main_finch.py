...
if __name__ == '__main__':
    ...
    for experiment in range(NUM_EXPERIMENTS):
        ...
        for index_secuencia, secuencia in enumerate(training_data):
            ...
            if num_sec < INITIAL_KNOWN: # Si todavía no hemos formado un grupo de 5 secuencias no realizamos el clustering, ya que, como hay un individuo por secuencia, hasta no tener 5 el clustering no podria crear 5 clusters robustos
                continue
