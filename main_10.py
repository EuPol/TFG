...
if __name__ == '__main__':
    ...
    df_f1_transpuesto.to_csv('resultados_f1_score_main_10.csv', index=False, header=False)
    df_overlap_transpuesto.to_csv('resultados_overlap_main_10.csv', index=False, header=False)
