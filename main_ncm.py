...
if __name__ == '__main__':
    ...
    df_f1_transpuesto.to_csv('resultados_f1_score_ncm_eu.csv', index=False, header=False)
    df_overlap_transpuesto.to_csv('resultados_overlap_ncm_eu.csv', index=False, header=False) 
